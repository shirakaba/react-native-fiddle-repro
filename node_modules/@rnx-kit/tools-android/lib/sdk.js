...
export const ANDROID_HOME = (() => {
    ...
    if (!home) {
        throw new Error("ANDROID_HOME is not set and is required to install and launch APKs");
    }
    return home;
})();
...
function latestVersion(versions) {
    ...
    for (const version of versions) {
        ...
        const value = Number(major) * 1000000 + Number(minor) * 1000 + Number(patch);
        if (maxValue < value) {
 ...
 */
export function getBuildToolsPath() {
